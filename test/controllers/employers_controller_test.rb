...
class EmployersControllerTest < ActionController::TestCase
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post :create, employer: { date_of_birth: @employer.date_of_birth, email: @employer.email, gender: @employer.gender, location: @employer.location, name: @employer.name, phone_number: @employer.phone_number }
    end
  ...
  test "should update employer" do
    patch :update, id: @employer, employer: { date_of_birth: @employer.date_of_birth, email: @employer.email, gender: @employer.gender, location: @employer.location, name: @employer.name, phone_number: @employer.phone_number }
    assert_redirected_to employer_path(assigns(:employer))
  end
